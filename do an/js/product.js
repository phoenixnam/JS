...
var product = [{
    ...
    img: 'https://toplist.vn/images/800px/style-han-quoc-713261.jpg',
    price: 122000,
},
{
    id: 'SP2',
...
},
{
    id: 'SP5',
    name: 'Áo dài hiện đại',
    img: 'https://toplist.vn/images/800px/lime-orange-713317.jpg',
    price: 654000,
},
{
    id: 'SP6',
...
function Save() {
    localStorage.setItem('listProduct', JSON.stringify(product));// lấy từ mảng 
}
// Lấy sản phẩm từ local storage
function load() {
    // products là lấy từ local store 
